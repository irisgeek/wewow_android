    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.layout_footer_share:
                ...
                su.setItemId(this.lc.id + "");
                su.setItemType(ShareActivity.ITEM_TYPE_COLLECTION);
                            ...
                            public void taskCompletionResult(byte[] result) {
                                ...
                                try {
                                    ...
                                    if (like == 1) {
                                        ...
                                        MessageBoxUtils.messageBoxWithNoButton(LifeLabItemActivity.this, true, s, 1000);
                                    } else {
                                        lcd.liked_count -= 1;
                                    }
                                    lifelab_fav_count.setText(lcd.liked_count + "");
                                    ...
                                    MessageBoxUtils.messageBoxWithNoButton(LifeLabItemActivity.this, false, s, 1000);
                                }
                            }
                        },
