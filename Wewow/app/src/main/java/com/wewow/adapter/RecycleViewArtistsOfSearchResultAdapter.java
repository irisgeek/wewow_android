...
public  class RecycleViewArtistsOfSearchResultAdapter
        extends RecyclerView.Adapter<RecycleViewArtistsOfSearchResultAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
           ...
           textViewArticleCount=(TextView)view.findViewById(R.id.textViewArticle);
            textViewFollowerCount=(TextView)view.findViewById(R.id.textViewFollow);
        }
    ...
    public RecycleViewArtistsOfSearchResultAdapter(Context context, ArrayList<HashMap<String, Object>> list) {
